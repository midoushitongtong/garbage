...
onMounted(async () => {
  ...
  //     url: 'http://t0.tianditu.gov.cn/cia_w/wmts?tk=c31970661040387d17945d86f84f7116',
  //     layer: 'cia',
  //     style: 'default',
  //     tileMatrixSetID: 'w',
  //     format: 'tiles',
  ...
  // viewer.entities.add({
  //   polygon: {
  //     hierarchy: Cesium.Cartesian3.fromDegreesArray([113.3191, 23.109, 110, 100, 90, 90, 80, 80]),
  ...
  // setTimeout(() => {
  //   const attribute = primitive.getGeometryInstanceAttributes('instance2');
  ...
  //     const attribute = primitive.getGeometryInstanceAttributes(id);
  //     attribute.color = Cesium.ColorGeometryInstanceAttribute.toValue(
  //       Cesium.Color.fromRandom({
  //         alpha: 0.5,
  //       })
  ...
  //             // material.diffuse = vec3(materialInput.st,  0.1);
  //             float strength = mod(materialInput.st.x + uTime, 1.0);
  ...
  // };
  // anime({
  //   targets: primitive.appearance.material.uniforms,
  //   uTime: 1,
  //   duration: 1000,
  //   easing: 'linear',
  //   loop: true,
  ...
  // const geoJSON = await Cesium.GeoJsonDataSource.load('/100000_full.json', {
  //   stroke: Cesium.Color.BLUE,
  //   fill: Cesium.Color.AQUA,
  // });
  // geoJSON.entities.values.forEach((item) => {
  //   if (item.polygon) {
  ...
  //       })
  //     );
  //     item.polygon.extrudedHeight = 1000000;
  //   }
  // });
  // viewer.dataSources.add(geoJSON);

  // const kmlData = await Cesium.KmlDataSource.load('/a.kml');
  ...
  //     { longitude: 1, latitude: 1, altitude: 1000 },
  //     { longitude: 2, latitude: 2, altitude: 2000 },
  //     { longitude: 3, latitude: 3, altitude: 3000 },
  //     { longitude: 4, latitude: 4, altitude: 4000 },
  //   ],
  // };
  ...
  // const start = Cesium.JulianDate.fromIso8601('2020-05-12T23:10:00Z');
  ...
  //   const airplaneUri = await Cesium.IonResource.fromAssetId(1);
